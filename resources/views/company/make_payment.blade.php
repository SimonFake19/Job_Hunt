...
<style>
    .page_top_image {
        background-image: url("{{ asset(' uploads/'.$global_banner_data->banner_company_panel) }}")
    }
</style>

@section('main_content')
<div class="page-top page_top_image">
    <div class="bg"></div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-lg-9 col-md-12">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <form action="{{route('company_paypal_success')}}" method="get">
                            @csrf
                            <tr>
                                <td class="w-200">
                        ...
                        <tr>
                            <form action="{{ route('company_stripe_success') }}" method="get">
                                @csrf
                                <td>
                                    <select name="package_id" class="form-control select2">
                                        @foreach($packages as $item)
